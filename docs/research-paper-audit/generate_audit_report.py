...
findings = [
    ...
    },
    {
        ...
        "why": "The mobile app exists, but the current mobile build is student-focused and teacher mobile is explicitly marked unsupported. Broad mobile parity claims are therefore overstated.",
        "evidence": [
            "Mobile app exists: mobile/package.json:27-40",
            "Teacher placeholder: mobile/src/screens/TeacherUnsupportedScreen.tsx:40,45",
            "Discussion board note: mobile/src/screens/ClassDetailScreen.tsx:1228",
        ],
    ...
    },
    {
        ...
        "evidence": [
            "Mobile note: mobile/src/screens/ClassDetailScreen.tsx:1228",
        ],
    ...
    },
    {
        ...
        "evidence": [
            "Mobile package: mobile/package.json:27-40",
        ],
...
feature_rows = [
    {
        ...
        "live": "Yes",
        "status": "Real",
        "evidence": "backend/src/common/constants/role.constants.ts:10; next-frontend/app/(auth)/login/page.tsx; mobile/src/screens/LoginScreen.tsx",
    ...
    },
    {
        ...
        "status": "Partial",
        "evidence": "mobile package and screen inventory; teacher unsupported placeholder",
...
def build_docx():
    ...
    add_bullets(doc, [
        ...
        "`backend/`, `next-frontend/`, `mobile/`, `ai-service/`",

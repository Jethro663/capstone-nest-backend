...
DOCX_OUT = AUDIT_DIR / "RESEARCH_PAPER_RECHECK_MAY03_REV2.docx"
MD_OUT = AUDIT_DIR / "paper_recheck_may03_rev2.md"
...
findings = [
    {
        ...
        "why": (
            "The current `mobile` app does not expose OTP verification, password-reset, or account-recovery screens. "

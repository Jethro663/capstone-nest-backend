...
findings = [
    ...
    },
    {
        ...
        "why": (
            "This still mixes two different implementation concerns. The repo tracks lesson completions and separately stores `time_spent_seconds` on assessment attempts. "
            "That does not prove timed module-view engagement in the way the figure describes it."
        ),
        "evidence": [
    ...
    },
    {
        ...
        "why": "The backend is NestJS, not NextJS. This is still a technical naming error in the architecture narrative.",
        "evidence": [
    ...
    },
    {
        ...
        "exact": (
            "`Figure 3 depicts the web use case diagram depicts...` / `Figure 4 illustrates the mobile use case diagram illustrates...`"
        ),
        "why": "Both sentences still repeat the main verb and read like incomplete line edits instead of polished academic prose.",
        "evidence": [
...
def build_docx():
    ...
    r = p.add_run("Research Paper Recheck - May 03 Draft Rev3")
    r.bold = True
    r.font.size = Pt(22)
    r.font.color.rgb = RGBColor(24, 55, 89)
    ...
    for line in [
        "This draft is almost there.",
        "It now has the correct frontend version statement and keeps the earlier major cleanup wins.",
        "The remaining work is a short accuracy-and-wording pass, not another structural rewrite.",
    ]:
        p = doc.add_paragraph()

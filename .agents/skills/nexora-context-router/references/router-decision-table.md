...
| Mobile audit | kernel + mobile + testing | backend, security | unrelated web or ai-service slices | audit student mobile, login flow, navigation, query invalidation, Expo health |

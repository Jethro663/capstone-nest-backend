...
type StudentTabScreen = {
  name: "Dashboard" | "Classes" | "Assessments" | "JA" | "Announcements" | "Profile";
  render: (props: any) => ReactNode;
};

type StudentStackScreen = {
  name:
    | "ClassWorkspace"
    | "ClassDetail"
    | "ModuleDetail"
...
export const studentTabScreens = [
  { name: "Dashboard", render: () => <DashboardRouteScreen /> },
  { name: "Classes", render: (props) => <ClassesScreen {...props} /> },
  { name: "Assessments", render: (props) => <AssessmentsScreen {...props} /> },
  { name: "JA", render: (props) => <JaScreen {...props} /> },
  { name: "Announcements", render: (props) => <AnnouncementsScreen {...props} /> },
  { name: "Profile", render: (props) => <ProfileScreen {...props} /> },
] as const satisfies ReadonlyArray<StudentTabScreen>;

export const studentStackScreens = [
  { name: "ClassWorkspace", kind: "support", render: (props) => <ClassWorkspaceScreen {...props} /> },
  {
    name: "ClassDetail",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Class Detail" subtitle="Parity route placeholder for class details." />,
  },
  {
    name: "ModuleDetail",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Module Detail" subtitle="Parity route placeholder for module details." />,
  },
  {
    name: "Courses",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Courses" subtitle="Parity route placeholder for the student courses view." />,
  },
  {
    name: "Lessons",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Lessons" subtitle="Parity route placeholder for the student lessons view." />,
  },
  {
    name: "LessonDetail",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Lesson Detail" subtitle="Parity route placeholder for a single lesson." />,
  },
  { name: "AssessmentDetail", kind: "parity", render: (props) => <AssessmentDetailScreen {...props} /> },
  { name: "AssessmentTake", kind: "parity", render: (props) => <AssessmentTakeScreen {...props} /> },
  { name: "AssessmentResults", kind: "parity", render: (props) => <AssessmentResultsScreen {...props} /> },
  {
    name: "AssessmentHistory",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Assessment History" subtitle="Parity route placeholder for assessment history." />,
  },
  {
    name: "Chatbot",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Chatbot" subtitle="Parity route placeholder for the student chatbot route." />,
  },
  { name: "Performance", kind: "parity", render: () => <PerformanceRouteScreen /> },
  {
    name: "Transcript",
    kind: "parity",
    render: () => <StudentRoutePlaceholder title="Transcript" subtitle="Parity route placeholder for the student transcript." />,
  },
  { name: "LXP", kind: "parity", render: () => <LxpRouteScreen /> },
  { name: "AiTutor", kind: "support", render: (props) => <AiTutorScreen {...props} /> },
] as const satisfies ReadonlyArray<StudentStackScreen>;

function isParityStudentStackScreen(
  screen: (typeof studentStackScreens)[number],
): screen is Extract<(typeof studentStackScreens)[number], { kind: "parity" }> {
  return screen.kind === "parity";
}

function isSupportStudentStackScreen(
  screen: (typeof studentStackScreens)[number],
): screen is Extract<(typeof studentStackScreens)[number], { kind: "support" }> {
  return screen.kind === "support";
}

export const studentParityStackScreens = studentStackScreens.filter(isParityStudentStackScreen);
export const studentSupportStackScreens = studentStackScreens.filter(isSupportStudentStackScreen);
...
function StudentNavigator() {
  return (
    <RootStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      {studentStackScreens.map((screen) => (
        <RootStack.Screen key={screen.name} name={screen.name}>
          {screen.render}
        </RootStack.Screen>
      ))}
    </RootStack.Navigator>

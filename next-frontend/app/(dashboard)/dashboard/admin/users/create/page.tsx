...
function validateField(
  ...
  switch (name) {
    ...
    case "contactNumber": {
      if (formData.role !== "teacher") return "";
      if (!value.trim())
        return "Contact number is required for teacher accounts";
  ...
  const handleSubmit = async () => {
    ...
    try {
      await userService.create({
        ...
        gradeLevel: isStudent
          ? (formData.gradeLevel as "7" | "8" | "9" | "10")
          : undefined,
        employeeId: isTeacher
          ? sanitizeEmployeeIdInput(formData.employeeId, 20)
          : undefined,
        contactNumber: isTeacher
          ? sanitizePhoneLocalInput(formData.contactNumber, 11)
          : undefined,
      });
    ...
    <AdminPageShell
      ...
      meta={
        <>
          ...
          <MetaItem
            label="Validation"
            value={isFormValid ? "Ready" : "In progress"}
          />
        </>
      }
    >
      ...
      >
        <div className="admin-form-grid admin-form-grid--three">
          <FieldWrapper label="First Name" error={errors.firstName}>
            <Input
              ...
              className={
                errors.firstName ? "border-red-500" : "admin-input rounded-lg"
              }
            />
          </FieldWrapper>
          <FieldWrapper label="Middle Name" error={errors.middleName}>
            <Input
              ...
              className={
                errors.middleName ? "border-red-500" : "admin-input rounded-lg"
              }
            />
          </FieldWrapper>
          <FieldWrapper label="Last Name" error={errors.lastName}>
            <Input
              ...
              className={
                errors.lastName ? "border-red-500" : "admin-input rounded-lg"
              }
            />
          </FieldWrapper>
        </div>
        ...
        <FieldWrapper label="Email Address" error={errors.email}>
          <Input
            ...
            className={
              errors.email ? "border-red-500" : "admin-input rounded-lg"
            }
          />
        </FieldWrapper>
        ...
        <div className="admin-form-grid admin-form-grid--three">
          <FieldWrapper label="User Role">
            <Select
              value={formData.role}
              disabled={loading}
              onValueChange={(v) => handleFieldChange("role", v as UserRole)}
            >
          ...
          <FieldWrapper
            ...
            error={isStudent ? errors.studentId : undefined}
          >
            <div className="relative">
              <Input
                ...
                className={
                  !isStudent
                    ? "admin-input cursor-not-allowed rounded-lg bg-muted pr-8 text-muted-foreground"
                    : errors.studentId
                      ? "border-red-500"
                      : "admin-input rounded-lg"
                }
              />
              {!isStudent ? (
                <Lock
          ...
          <FieldWrapper
            label="Grade Level"
            error={isStudent ? errors.gradeLevel : undefined}
          >
            <Select
              value={isStudent ? formData.gradeLevel : ""}
              disabled={!isStudent || loading}
              onValueChange={(v) => handleFieldChange("gradeLevel", v)}
            >
              <SelectTrigger
                className={
                  isStudent && errors.gradeLevel
                    ? "border-red-500"
                    : "admin-input rounded-lg"
                }
              >
      ...
      >
        <div className="admin-form-grid admin-form-grid--two">
          <FieldWrapper
            ...
            error={isTeacher ? errors.employeeId : undefined}
          >
            <div className="relative">
              <Input
          ...
          <FieldWrapper
            ...
            error={isTeacher ? errors.contactNumber : undefined}
          >
            <div className="relative">
              <Input
        ...
        <div className="admin-inline-note">
          ...
          <div>
            ...
            <p>
              The user receives a verification email with OTP and sets their
              password after verifying email.
            </p>
          </div>
        </div>

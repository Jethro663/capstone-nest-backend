      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Register a new account with role-specific required fields.
          </p>
        </div>
        <Button variant="outline" onClick={() => router.push('/dashboard/admin/users')} disabled={loading}>
          Back to Users
        </Button>
      </div>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <FieldWrapper label="Grade Level" error={isStudent ? errors.gradeLevel : undefined}>
              ...
              >
                <SelectTrigger className={isStudent && errors.gradeLevel ? 'border-red-500' : ''}>
          ...
          <div className="flex items-start gap-3 rounded-md border border-blue-200 bg-blue-50 p-3 text-sm text-blue-800">
            ...
            <div>
              ...
              <p className="text-blue-700">
                The user receives a verification email with OTP and sets their password after verifying email.
              </p>
            </div>
          </div>

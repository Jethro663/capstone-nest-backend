...
const mockedDownloadReportPdf = downloadReportPdf as jest.MockedFunction<
  typeof downloadReportPdf
>;
...
describe("ClassRecordReportsPage", () => {
  ...
  beforeEach(() => {
    ...
    mockedReportService.getClassEnrollment.mockResolvedValue({
      data: [],
    } as any);
    mockedReportService.getStudentPerformance.mockResolvedValue({
      data: [],
    } as any);
    mockedReportService.getInterventionParticipation.mockResolvedValue({
      data: [],
    } as any);
    mockedReportService.getAssessmentSummary.mockResolvedValue({
      data: [],
    } as any);
  ...
  it("identifies archived learners in the intervention list", async () => {
    mockedClassRecordService.getInterventionReport.mockResolvedValue({
      data: [
        {
          id: "grade-1",

...
export type RoleDrawerIcon = ComponentProps<
  ...
  teacher: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Class Record",
          route: "TeacherClassRecord",
          kind: "tab",
          icon: "table-large",
        },
        {
          label: "Announcements",
          route: "TeacherAnnouncements",
          kind: "tab",
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Interventions",
          route: "TeacherInterventions",
          kind: "tab",
          icon: "account-heart-outline",
        },
        {
          label: "Performance",
          route: "TeacherPerformance",
          kind: "tab",
          icon: "chart-line",
        },
        {
          label: "Evaluations",
          route: "TeacherEvaluations",
          kind: "tab",
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Class Record",
          route: "AdminClassRecord",
          kind: "tab",
          icon: "table-large",
        },
        {
          label: "User Reports",
          route: "AdminUserReports",
          kind: "tab",
...
export function flattenRoleDrawerDestinations(
  role: RoleDrawerRole,
): RoleDrawerDestination[] {

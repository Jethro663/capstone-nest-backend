...
export function PerformanceScreen(_: Props) {
  ...
  const averageScore =
    performanceQuery.data?.overall.averageBlendedScore ?? null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Track current standings, at-risk classes, and the latest subject-level
                ...
                >
                  ...
                  >
                    ...
                    <Pill
                      ...
                      backgroundColor={
                        entry.isAtRisk ? colors.paleRed : colors.paleGreen
                      }
